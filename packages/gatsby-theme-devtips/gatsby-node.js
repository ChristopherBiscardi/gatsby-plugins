...
exports.onCreateNode = async ({
  ...
  if (node.internal.type === `Mdx`) {
    ...
    if (parent.sourceInstanceName === "gatsby-theme-devtips") {
...
exports.createPages = ({ graphql, actions }) => {
  ...
  return graphql(
    ...
    createPage({
      path: `/devtips`,
      component: require.resolve(`./src/templates/devtip-collections-query.js`),
      context: {}
    });
    ...
    result.data.allTipCollections.nodes.forEach(({ slug }) => {
      createPage({
        path: `/devtips/${slug}`,
        component: require.resolve(
          `./src/templates/devtip-collection-query.js`
        ),
        context: {
          slug
        }
